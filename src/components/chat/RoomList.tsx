...
export default function RoomList({ onSelectRoom, selectedRoomId, onNewChat, onNewGroup }: RoomListProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-b from-white/50 to-cream/30">
      <div className="p-5 border-b-2 border-white/40">
        <div className="flex items-center gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-20 pr-5 py-4 bg-white/90 border-2 border-white/60 rounded-2xl focus:outline-none focus:border-primary/50 focus:shadow-xl focus:bg-white transition-all text-base font-semibold placeholder:text-dark-brown/40 shadow-lg backdrop-blur-sm hover:border-primary/30"
            />
          </div>

          <button
            onClick={() => setShowAllUsers(!showAllUsers)}
            className={`flex items-center justify-center gap-2 px-5 py-4 rounded-2xl font-bold text-sm transition-all whitespace-nowrap ${
              showAllUsers
          ...
          <button
            onClick={onNewGroup}
            className="flex items-center justify-center px-4 py-4 bg-white/90 border-2 border-primary/30 text-primary rounded-2xl font-bold text-sm shadow-lg hover:shadow-xl transition-all hover:scale-110 active:scale-95"
            title="Create Group"
          >
